...
COLLECT_SCRIPT="$ROOT/scripts/phase1-autoregressive-1.9-module-optimization/20260312_prediction_memory_decoder/collect_prediction_memory_results.py"
MODULE_LOG_ROOT="$ROOT/results/logs/phase1-autoregressive-1.9-module-optimization/20260312_prediction_memory_decoder"
...
run_window "250ms" "train_1p9_prediction_memory_250ms" &
pid_250=$!
echo "$pid_250" > "$MODULE_LOG_ROOT/250ms/job.pid"
echo "250ms job pid=$pid_250"

run_window "500ms" "train_1p9_prediction_memory_500ms" &
pid_500=$!
echo "$pid_500" > "$MODULE_LOG_ROOT/500ms/job.pid"
echo "500ms job pid=$pid_500"

run_window "1000ms" "train_1p9_prediction_memory_1000ms" &
pid_1000=$!
