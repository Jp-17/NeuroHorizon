...
COLLECT_SCRIPT="$ROOT/scripts/phase1-autoregressive-1.9-module-optimization/20260320_decoder_scheduled_sampling/collect_decoder_scheduled_sampling_results.py"
...
for setting in "${SETTINGS[@]}"; do
  ...
  for window in "${WINDOWS[@]}"; do
    ...
    "$PYTHON" examples/neurohorizon/train.py \
      ...
      wandb.run_name="${setting}_${window}_formal" \
      "${overrides[@]}" \
