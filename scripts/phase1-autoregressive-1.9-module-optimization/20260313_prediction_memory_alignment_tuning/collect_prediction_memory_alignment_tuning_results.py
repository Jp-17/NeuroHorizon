#!/usr/bin/env python3
"""Collect, summarize, and register prediction-memory-alignment-tuning experiment results."""
...
MODULE = "20260313_prediction_memory_alignment_tuning"
...
def main():
    ...
    summary_path = FIG_ROOT / "prediction_memory_alignment_tuning_summary.json"
    ...
    new_row = {
        ...
        "date": str(date.today()),
        "description": "prediction memory alignment tuning",
