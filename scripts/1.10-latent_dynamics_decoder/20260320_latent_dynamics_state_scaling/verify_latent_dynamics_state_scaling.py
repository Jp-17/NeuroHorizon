#!/usr/bin/env python3
"""Basic functional checks for the 1.10 latent-dynamics state-scaling decoder."""
...
def main() -> None:
    ...
    model = NeuroHorizon(
        ...
        latent_dynamics_num_queries=8,
        latent_dynamics_pool_token_dim=64,
        latent_dynamics_state_dim=256,
    )
    model.eval()
    ...
    print("latent_dynamics state scaling verification passed")
