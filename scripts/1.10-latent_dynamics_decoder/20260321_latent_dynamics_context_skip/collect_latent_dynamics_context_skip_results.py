#!/usr/bin/env python3
"""Collect 1.10 context-skip gate results into summary json and TSV."""
...
def main() -> None:
    ...
    summary_path = fig_root / "latent_dynamics_context_skip_summary.json"
    ...
    tsv_update = {
        ...
        "date": "2026-03-21",
        "description": "Context-conditioned latent dynamics 500ms gate",
        "fp_bps_250ms": "",
        ...
        "notes": (
            ...
            "persistent pooled context injected into rollout inputs and output residual"
        ),
    }
