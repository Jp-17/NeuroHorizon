#!/usr/bin/env python3
"""Basic functional checks for the 1.10 latent-dynamics context-skip decoder."""
...
def main() -> None:
    ...
    model = NeuroHorizon(
        ...
        latent_dynamics_pool_token_dim=32,
        latent_dynamics_state_dim=128,
        latent_dynamics_context_conditioning=True,
        latent_dynamics_context_dim=128,
    )
    model.eval()
    ...
    print("latent_dynamics context skip verification passed")
