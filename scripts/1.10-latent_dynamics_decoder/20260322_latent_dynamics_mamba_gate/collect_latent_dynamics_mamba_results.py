#!/usr/bin/env python3
"""Collect 1.10 Mamba gate results into summary json and TSV."""
...
def main() -> None:
    ...
    summary_path = fig_root / "latent_dynamics_mamba_summary.json"
    ...
    tsv_update = {
        ...
        "date": "2026-03-22",
        "description": "Mamba latent dynamics 500ms gate",
        "fp_bps_250ms": "",
        ...
        "notes": (
            ...
            "latent dynamics backbone switched from GRU to Mamba with prev_latent rollout"
        ),
    }
