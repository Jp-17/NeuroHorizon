#!/usr/bin/env python3
"""Generate training-curve panels for Phase 1.10 latent-dynamics runs."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Plot epoch-level train/val curves for Phase 1.10 latent-dynamics "
    ...
    parser.add_argument(
        ...
        action="append",
        dest="modules",
        help="Optional module directory name under results/figures/1.10-latent_dynamics_decoder.",
    )
...
def figures_root(root: Path) -> Path:
    return root / "results" / "figures" / "1.10-latent_dynamics_decoder"
