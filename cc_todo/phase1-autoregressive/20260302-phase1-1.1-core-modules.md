...
- **配置文件**：`examples/neurohorizon/configs/`
  - `train_small.yaml` — Small 配置基础版
  - `train_small_250ms.yaml` — 250ms 预测窗口
  - `train_small_500ms.yaml` — 500ms 预测窗口
  - `train_small_1000ms.yaml` — 1000ms 预测窗口
...
| `examples/neurohorizon/configs/*.yaml` | 新建（5 个配置文件） |
